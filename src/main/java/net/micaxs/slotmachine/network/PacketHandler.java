...
public class PacketHandler {
    ...
    public static void register() {
        ...
        net.messageBuilder(ClaimPayoutC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER).decoder(ClaimPayoutC2SPacket::new).encoder(ClaimPayoutC2SPacket::toBytes).consumerMainThread(ClaimPayoutC2SPacket::handle).add();
        ...
        net.messageBuilder(ServerClaimPayoutC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER).decoder(ServerClaimPayoutC2SPacket::new).encoder(ServerClaimPayoutC2SPacket::toBytes).consumerMainThread(ServerClaimPayoutC2SPacket::handle).add();
    }
